...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args, max_height=None, min_height=None, num_categories=None):
        ...
        if num_categories is not None:
            self.num_sem_categories = num_categories

        self.max_height = int(360 / self.z_resolution)
        self.min_height = int(-150 / self.z_resolution)
        self.max_z_consider = 180 + 1
        ...
        self.camera_matrix = du.get_camera_intrinsic_parameters(
    ...
    def forward(self, obs, pose_obs, maps_last, poses_last, camera_param):
        bs, c, h, w = obs.size()
        depth = obs[:, 3, :, :]
