...
def get_args():
    ...
    if args.map_id == 3:
        ...
        args.split = 'TG'
        # args.num_sem_categories = 18
        # args.num_eval_episodes = 17
        args.num_sem_categories = 15
        if args.task == 'objectnav':
            args.num_eval_episodes = 14
            # args.episodes_dir = 'dataset/objectnav_2/'
        elif args.task == 'reasoning':
            args.num_eval_episodes = 69
            args.episodes_dir = 'dataset/reasoning/'
        elif args.task == 'simple':
            args.num_eval_episodes = 70
            args.episodes_dir = 'dataset/simple/'
        elif args.task == 'vln':
        ...
        if args.task == 'objectnav':
            args.num_eval_episodes = 32
        elif args.task == 'reasoning':
            args.num_eval_episodes = 81
            args.episodes_dir = 'dataset/reasoning/'
        elif args.task == 'simple':
            args.num_eval_episodes = 160
            args.episodes_dir = 'dataset/simple/'
        elif args.task == 'vln':
            args.num_eval_episodes = 60
            args.episodes_dir = 'dataset/vln/'
        else:
            raise ValueError('Unknown task!')
        args.categories_file = 'dataset/objectnav/NursingRoom_categories.json'
        args.max_episode_length = 2000
